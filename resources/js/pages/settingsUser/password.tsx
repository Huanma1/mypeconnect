    ...
    return (
        <SettingsUserLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6">
                <HeadingSmall title="Update your password" description="Ensure your account is using a long, random password to stay secure." />
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {recentlySuccessful && <p className="text-sm text-neutral-600">Password updated successfully.</p>}
                    </div>
                </form>
            </div>
        </SettingsUserLayout>
